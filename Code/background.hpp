 ...
 * 
 * This also shows once of the design features that is abtract factory as it instantiates all the class here 
 * 
 * Note: this class is not being used since it was not integrated in time 
 * */
